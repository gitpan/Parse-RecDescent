...
This document describes version 1.64 of Parse::RecDescent,
...
The C<E<lt>skip<gt>> directive enables the terminal prefix used in
...
The C<E<lt>skip<gt>> directive evaluates to the I<previous> terminal prefix,
